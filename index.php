...
require_once("lib/DB/dbManager.php");

require_once("lib/Logic/shopCart.php");
...
$shopCart->addRecipe($dbManager->recipe->getRecipe(2));
$shopCart->addRecipe($dbManager->recipe->getRecipe(1));
$shopCart->addRecipe($dbManager->recipe->getRecipe(2));

$shopCart->removeRecipe($dbManager->recipe->getRecipe(2));
echo "<br><br>";
$shopCart->removeRecipe($dbManager->recipe->getRecipe(2));
echo "<br><br>";
$shopCart->removeRecipe($dbManager->recipe->getRecipe(2));
